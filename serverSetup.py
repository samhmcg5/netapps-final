...
squid['encoding'] = face_recognition.face_encodings(loaded)[0]
...
eric['encoding'] = face_recognition.face_encodings(loaded)[0]
...
alex['encoding'] = face_recognition.face_encodings(loaded)[0]
