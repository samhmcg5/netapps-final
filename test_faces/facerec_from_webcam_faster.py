...
alex_image = face_recognition.load_image_file("alex6.jpg")
alex_face_encoding = face_recognition.face_encodings(alex_image)[0]

sam_image = face_recognition.load_image_file("squid1.jpeg")
...
while True:
    ...
    if process_this_frame:
        ...
        for face_encoding in face_encodings:
            ...
            match_sam = face_recognition.compare_faces([sam_face_encoding], face_encoding)
            name = "Unknown"
